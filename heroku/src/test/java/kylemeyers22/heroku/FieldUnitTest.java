...
public class FieldUnitTest extends FieldActivity{
    ...
    FieldUnitTest.HttpUrlActivity activity;
    ...
    public class HttpUrlActivity extends Activity {
        ...
        public HttpUrlActivity() throws MalformedURLException, IOException {
            this((HttpURLConnection) new URL("http://baseballsim.heroku.com/api/fields").openConnection());
        }
    ...
    public void setUp() {
        ...
        activity = new FieldUnitTest.HttpUrlActivity(mockHttpConnection);
    }
