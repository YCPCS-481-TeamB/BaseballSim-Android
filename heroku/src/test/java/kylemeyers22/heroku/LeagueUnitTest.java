...
public class LeagueUnitTest extends LeagueActivity{
    ...
    LeagueUnitTest.HttpUrlActivity activity;
    ...
    public class HttpUrlActivity extends Activity {
        ...
        public HttpUrlActivity() throws MalformedURLException, IOException {
            this((HttpURLConnection) new URL("http://baseballsim.heroku.com/api/leagues").openConnection());
        }
    ...
    public void setUp() {
        ...
        activity = new LeagueUnitTest.HttpUrlActivity(mockHttpConnection);
    }
